package com.example.zen.receivers
...
import com.example.zen.util.PulseNotificationHelper
...
class ReminderReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_TRIGGER_REMINDER = "com.example.zen.action.TRIGGER_REMINDER"
        const val EXTRA_HABIT_ID = "extra_habit_id"
        const val EXTRA_TIME = "extra_time"
        const val EXTRA_IS_MOOD = "extra_is_mood"
        const val EXTRA_IS_HYDRATION = "extra_is_hydration"

        const val ACTION_QUICK_ADD = "com.example.zen.action.QUICK_ADD"
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (intentAction == ACTION_TRIGGER_REMINDER) {
            ...
            android.util.Log.d("ReminderReceiver", "Triggering reminder for habit: $habitId, time: $timeStr, isMood: $isMood")
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                val quickIntent = Intent(context, ReminderReceiver::class.java).apply {
                ...
                val builder = if (isMood) {
                    ...
                    PulseNotificationHelper.createNotificationBuilder(context, habitId.hashCode(), PulseNotificationHelper.CHANNEL_MOOD)
                    ...
                    PulseNotificationHelper.createNotificationBuilder(context, habitId.hashCode(), PulseNotificationHelper.CHANNEL_HYDRATION)
                        .setContentTitle(title)
                        .setContentText(content)
                        .setSmallIcon(android.R.drawable.ic_dialog_info)
                    ...
                    PulseNotificationHelper.createNotificationBuilder(context, habitId.hashCode(), PulseNotificationHelper.CHANNEL_GENERAL)
                        .setContentTitle(title)
                        .setContentText(content)
                        .setSmallIcon(android.R.drawable.ic_dialog_info)
                } else {
                    ...
                    PulseNotificationHelper.createNotificationBuilder(context, habitId.hashCode())
                        .setContentTitle(title)
                        .setContentText(content)
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                PulseNotificationHelper.cancelNotification(context, habitId.hashCode())
                com.example.zen.widgets.ZenWidgetProvider.WidgetUpdateHelper.updateAllWidgets(context)
            }
        }
    }
}
...
// extension helper
fun com.example.zen.models.Habit.defaultIncrementLabel(): String {
