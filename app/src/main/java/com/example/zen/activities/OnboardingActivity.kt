...
class OnboardingActivity : AppCompatActivity() {
    ...
    private val onboardingPages = listOf(
        OnboardingPage(
            imageRes = R.drawable.zen_logo,
            title = "Zen",
            description = "Small habits. Quiet progress that shapes your everyday life."
        ),
        OnboardingPage(
            imageRes = R.drawable.onboarding2,
            title = "Tiny steps, big change",
            description = "Build one habit at a time, track streaks, and feel steady growth."
        ),
        OnboardingPage(
            imageRes = R.drawable.onboarding3,
            title = "Focus without distractions",
            description = "No noise, no ads — just a peaceful space to build mindful routines."
        )
    )
